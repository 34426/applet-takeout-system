<template>
  <div style="position: relative;" v-bind="listrou">
    ...
    <!-- 语音播报 -->
    <div>
      <!-- http://h.thexxdd.cn/video/meituan.mp3 -->
      <audio src="https://waiamai.oss-cn-shenzhen.aliyuncs.com/resources/https___www.text-to-speech.cn_mp3_546161588_1675568378_0.mp3" ref="audio"></audio>
    </div>
    <!--二级路由渲染-->
      ...
      methods:{
        ...
        newTips(){
          Utils.$on('neworder', (msg)=> {
                ...
                console.log("======")
                console.log(localStorage.getItem("goeasyid")+"=========")
                this.tiporder = 0
                this.orderlist = 0
          })
        },
        ...
        tongxun(){
          ...
          console.log("inde.vue "+localStorage.getItem("goeasyid")+"=========")
          // console.log("inde.vue "+this.opendata.goeasyid+"=========")
          // console.log(this.userInfo.token+"=========")
          // this.opendata.opening
          this.$goEasy.subscribe({
              channel: localStorage.getItem("goeasyid"), //替换为您自己的channel
              onMessage:  (message)=> {
                  console.log("inde.vue "+message.channel)
                  if(message.channel === localStorage.getItem("goeasyid")){
                    this.$nextTick(()=>{
                       this.notiFy()
                       this.plays()
                       this.tiporder = 1
        ...
        signOut(){
          ...
          localStorage.removeItem("goeasyid")
          //跳转页面
